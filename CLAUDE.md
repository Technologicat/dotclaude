...
- **extrafeathers** — agility and ease-of-use batteries for the FEniCS FEM solver: `~/Documents/koodit/extrafeathers`
- **randomthought** — an AI-based ROM accelerator for 2D PDEs: `~/Documents/koodit/randomthought`
