...
**And say which ones you asserted.** At the end of a commit, list the decision *whys* that came from your own inference rather than from a source — usually two or three lines. That points a review at the risky sentences instead of at all of them, which is the only version of this that scales: reviewing is the scarce resource, and the sentences most likely to be wrong are the ones least likely to look it.
